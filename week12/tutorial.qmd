...
Had to run this in the week 12 folder in the terminal in R
cd C:\Users\jjew0003\Documents\Monash Teaching\ETC3250-5250\2025\week12
quarto install extension ginolhac/unilur

or 
cd C:\Users\jjew0003\Documents\Monash_Yr1\ETC3250\S12025\S12025\week12
quarto install extension ginolhac/unilur
-->
...
<!---
It is one of the examples in the book ["Market Segmentation Analysis: Understanding It, Doing It, and Making It Useful" by Sara Dolnicar, Bettina Grün and Friedrich Leisch](https://homepage.boku.ac.at/leisch/MSA/). 

The data can be obtained using the following code:
--->
...
Download the data from moodle, place it in the same folder as this `tutorial.qmd` and laod it by running

```{r}
risk <- readRDS("risk_MSA.rds")
```
