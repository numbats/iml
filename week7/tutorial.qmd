...
Had to run this in the week 7 folder in the terminal in R
cd C:\Users\jjew0003\Documents\Monash Teaching\ETC3250-5250\2025\week7
quarto install extension ginolhac/unilur

or 
cd C:\Users\jjew0003\Documents\Monash_Yr1\ETC3250\S12025\S12025\week7
quarto install extension ginolhac/unilur
-->
...
ind <- sample(1:60000, 1)
img <- as.data.frame(train_images[ind, , ])
...
activations_model_fashion <- keras_model(
  inputs = model_fashion_mnist$layers[[1]]$input,
