...
```
install.packages(c("knitr", "tidyverse", "tidymodels", "gapminder", "gridExtra", "patchwork", "tourr", "kableExtra", "fpc", "statquotes", "yardstick", "ISLR", "broom", "mvtnorm", "ggdendro", "RColorBrewer", "plotly", "htmltools", "splines", "grid", "rpart", "mgcv", "gratia", "GGally", "ggpubr", "MASS", "caret", "modelr", "boot", "gganimate", "ggrepel", "ggthemes", "datasauRus", "geozoo", "ggparallel", "ggmosaic", "nullabor", "rpart.plot", "e1071", "viridis", "randomForest", "mlbench", "gtable", "keras", "nnet", "penalizedLDA", 
"ggExtra", "magick"))
```
