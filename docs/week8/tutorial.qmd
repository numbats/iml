...
- For observations 4 (111) and 6 (129), `bd` and `bm` have some importance.  
- For observation 9 (295), `fl` has some importance.
...
| 122 | Adelie | Adelie    | | | |
| 129 | Adelie | Chinstrap | `bd`, `bm` | | |
| 281 | Chinstrap | Chinstrap | | | `bm` |
| 292 | Chinstrap | Chinstrap | | | |
| 295 | Chinstrap | Adelie | `fl` | `fl` | `bm` |
