...
The elements $\phi_{11},\dots,\phi_{p1}$ are the [loadings]{.monash-orange2} of the first principal component.
...
> [*Sometimes the lowest PCs show the interesting patterns, like non-linear relationships, or clusters.*]{.monash-pink2}

:::
::: {.column}
::: {.fragment}
- PCA summarises [linear]{.monash-orange2} relationships, and might not see other interesting dependencies
