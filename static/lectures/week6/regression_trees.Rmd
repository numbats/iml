...
```{r out.width="100%"}
hitters_rp <- rpart(lSalary~Hits+Years, data=hitters_tr, control=rpart.control(minsplit=6, cp=0.02))
...
ggplot(Hitters, aes(x=Years, y=Hits, colour=lSalary)) + geom_point(alpha=0.7, size=3) +
  scale_colour_viridis() + 
  geom_vline(xintercept=4.5) + 
  annotate("segment", x=0, xend=4.5, y=105.5, yend=105.5) +
  annotate("segment", x=4.5, xend=25, y=118, yend=118) +
