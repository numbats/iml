...
.grid[
.item[
.border-box.monash-border-blue[
Me - Hi! Responsible for everything.

<img src="https://numbat.space/authors/cook-di/avatar_huc410300e956b91907a41e009b4d53c45_149728_270x270_fill_q90_lanczos_center.jpg" width="200px">
]
]

.item[
.border-box.monash-border-blue[
Patrick - 2nd year PhD student - Tutoring two sessions - and lead tutor.

<img src="https://numbat.space/authors/li-patrick/avatar_huc299a4b0e1485034e36b776b7382ae71_108232_270x270_fill_q90_lanczos_center.jpg" width="200px">
]
]

.item[
.border-box.monash-border-blue[
Harriet - 1st year PhD students - Tutoring two sessions.

<img src="https://numbat.space/authors/mason-harriet/avatar_hu81619a442e984d1e8ff23f5ac72577c8_63680_270x270_fill_q90_lanczos_center.jpg" width="200px">
...
.item[
.border-box.monash-border-blue[
Brenwin - MBAt graduate - Tutoring three sessions.

<img src="images/brenwin.jpg" width="200px">
...
.item[
.border-box.monash-border-blue[
Brendi - MBAt graduate - Tutoring three sessions.

<img src="images/brendi.jpg" width="200px">
...
- **Website** (https://iml.numbat.space) has the schedule, lecture slides, and tutorial instructions. 
- **Textbook** (https://www.statlearning.com) free pdf online, and some data. Code will be primarily from [Emil Hvitfeldt's site](https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/statistical-learning.html).
- Got questions? .monash-orange2[Post in the moodle discussion forum]. Of a .monash-blue2[private] nature (e.g. about marks) you can send email to .monash-blue2[etc3250.clayton-x@monash.edu]. No response will result from emailing tutors or the instructor. 
...
- Using [R](https://cran.r-project.org) (4.1.2 (2021-11-01) -- "Bird Hippie") and the [RStudio](https://rstudio.com) (RStudio 2021.09.0+351 "Ghost Orchid")
- If you are new to R or need a refresher work yourself through the materials at https://learnr.numbat.space by the end of week 2.
...
- The .monash-orange2[code for running examples] in the lecture slides can be found in the `Rmd` file. Look for the chunks of R code, and run from them from the start to end. 
- We will also be utilising the [tidymodels](https://www.tidymodels.org) way of thinking and structuring the code. You can see textbook lab code that uses tidymodels at https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/statistical-learning.html. 
- If you have computing problems, follow the guidelines at https://learnr.numbat.space/chapter3 for making .monash-orange2[a reproducible example] of what you are trying to do and the error you are getting. 

---
# Assessment

- 60% final exam, 9% for the project, and each assignment, and 4% total from weekly quizzes.
- Your final total quiz mark will be based on your best 10 of the 12 scores. Quizzes will be due each Tues 9am, starting in week 1.  
- Assignments are due weeks 4, 7, 9. Project due week 11. ETC5250 will also need to make a short video of their project modeling, as part of project mark. 
- All three assignments and the project need to be completed. Instructions are provided two weeks ahead of the due date, so plan ahead. If you miss submitting an assignment or the project, through illness, or personal difficulty, the procedure to follow is (1) notify the CE within seven days of the due date, ETC3250.Clayton-x@monash.edu, (2) your score will be the lowest score from the other assignments/project for the missed work. Failure to submit and notify the CE accordingly will result in a zero score. 
- These flexibilities in assessments should mean that there is no need to request special consideration. 
...
---
background-image: url(https://upload.wikimedia.org/wikipedia/commons/e/eb/Math.svg)
background-position: center bottom
background-size: 35%

# Notation

- These slides provide the glossary of math notation used in the lectures slides, and an explanation of main math elements.
- Math notation is useful for concise description of methods and for how to think about the methods conceptually.
