...
- Moodle: zoom links, assignments, marks, discussion forum, and announcements
...
and then an observation can be written as 
...
Suppose that ${\mathbf A}$ is square and symmetric
