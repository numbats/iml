...
- [volume ($\lambda_k$)]{.monash-blue2}: each cluster has approximately the same size
- [shape ($A_k$)]{.monash-blue2}: each cluster has approximately the same variance so that the distribution is spherical
- [orientation ($D_k$)]{.monash-blue2}: each cluster is forced to be axis-aligned
