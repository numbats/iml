...
Had to run this in the week 6 folder in the terminal in R
cd C:\Users\jjew0003\Documents\Monash Teaching\ETC3250-5250\2025\week6
quarto install extension ginolhac/unilur

or 
cd C:\Users\jjew0003\Documents\Monash_Yr1\ETC3250\S12025\S12025\week6
quarto install extension ginolhac/unilur
-->
...
Notice here that we use the `ranger` package engine rather than `randomForest` as this has functionality for permutation importance. An advantage of the `tidymodels` formulation is that you cna use a different engine and the rest of your code stays the same. 
